...
2024/11/1以前の記事は対象外にすることなども検討できると思いましたが、一旦今回は簡単な分析なので進めます。

# 1. 概要分析

まず、記事の基本的な統計量を確認しました。
整理したのみで、機械学習は使っていません。
...
今回の分析で、人気記事の特徴が定量的に把握できました。これらの知見を活かして、私もより多くの方に読んでいただける記事を作成していきたいと思います。
