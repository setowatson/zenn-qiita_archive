...
![](https://storage.googleapis.com/zenn-user-upload/4e34f7b60a3c-20250911.png =550x)
*保存されたViewをクエリーUIから選択*

![](https://storage.googleapis.com/zenn-user-upload/cee7ab6e4a8f-20250911.png =550x)
*すぐに再利用できる*
...
:::details 直近 7 日間に実行されたクエリのWHERE句ごとの出現回数を集計
...
![](https://storage.googleapis.com/zenn-user-upload/72c10198d32d-20250911.png =550x)
実際の出力例*
...
![](https://storage.googleapis.com/zenn-user-upload/dd5b3bc8ad8b-20250910.png =550x)
*保存していたビューをSQL1行で実行*

![](https://storage.googleapis.com/zenn-user-upload/5e3f63272af3-20250911.png =550x)
*グラフ化もすぐにできます*
